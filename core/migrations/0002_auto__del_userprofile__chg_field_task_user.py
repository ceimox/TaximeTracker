...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_task', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Task.user'
        db.alter_column(u'core_task', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UserProfile']))
